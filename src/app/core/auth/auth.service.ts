...
import { JwtClaim } from 'src/app/core/auth/interfaces/jwt-claim.model';
import jwt_decode from 'jwt-decode';
import * as _ from 'lodash';
import { JwtRs } from 'src/app/core/auth/interfaces/jwt-rs.interface';
...
export class AuthService {
  ...
  private readonly URL_LOGIN = ApiConfig.url + '/api/login';
  private readonly URL_REFRESH = ApiConfig.url + '/api/refresh-token';
